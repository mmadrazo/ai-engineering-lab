...
El proyecto incluye un cliente web en Streamlit para pegar una transcripcion y ver la estimacion desde una interfaz de chat.

```bash
streamlit run streamlit_app.py
```

La logica de apoyo del cliente esta en `web/`, mientras que `streamlit_app.py` se mantiene en la raiz como punto de entrada solicitado.
...
├── streamlit_app.py        # Cliente web Streamlit
├── web/                    # Utilidades del cliente web
